...
with general_decision:
    ...
    if(status((image_classification_performance/17)*100, 70) == 'Pass' and status((logistic_performance / 17)*100, 75) == 'Pass' and status((structural_performance_value/15)*100, 80) == 'Pass' ):
